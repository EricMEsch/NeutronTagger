...
G4VPhysicalVolume *MyDetectorConstruction::Construct(){
    ...
    G4double cryrad = 350*cm;
    G4double cryhheight = 350*cm;
    G4double detectorrad = cryrad + 80*cm;
    ...
    //20cm PMMA tube
    solidPMMA = new G4Tubs("solidPMMA", 0, cryrad + plateThick + plateDist, cryhheight + plateThick + plateDist, 0, CLHEP::twopi);
    ...
    /*Outer Steel Border*/
    solidouterCryoborder = new G4Tubs("solidouterCryoborder", 0.0 * cm, cryrad, cryhheight, 0, CLHEP::twopi);
    ...
    /*Vacgap Steel Border*/
    solidVacGap = new G4Tubs("solidVacGap", 0.0 * cm, (cryrad - cryowall),
                                   (cryhheight - cryowall), 0, CLHEP::twopi);
    ...
    /*Inner Steel Border*/
    solidCryoborder = new G4Tubs("solidCryoborder", 0.0 * cm, (cryrad - cryowall - vacgap),
                                   (cryhheight - cryowall - vacgap), 0, CLHEP::twopi);
    ...
    /*Liquid argon inside cryostat*/
    solidCryo = new G4Tubs("solidCryo", 0.0 * cm, (cryrad - 2 * cryowall - vacgap),
                                  (cryhheight - 2 * cryowall - vacgap), 0, CLHEP::twopi);
    ...
    //
    auto* lidSolid =
        new G4Tubs("Lid", 0.0 * cm, cryrad, cryowall / 2.0 , 0.0, CLHEP::twopi);
    auto* fLidLogical = new G4LogicalVolume(lidSolid, Steelmat, "Lid_log");
    auto* fLidPhysical =
        new G4PVPlacement(nullptr, G4ThreeVector(0., 0., (cryhheight + cryowall / 2.0)),
                        fLidLogical, "Lid_phys", logicPMMA, false, 0, true);
    auto* fBotLogical = new G4LogicalVolume(lidSolid, Steelmat, "Bot_log");
    auto* fBotPhysical =
        new G4PVPlacement(nullptr, G4ThreeVector(0., 0., -(cryhheight + cryowall / 2.0)),
                        fBotLogical, "Bot_phys", logicPMMA, false, 0, true);
