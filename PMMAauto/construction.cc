...
G4VPhysicalVolume *MyDetectorConstruction::Construct(){
    ...
    solidInnerWatertank = new G4Tubs("solidInnerWatertank", 0, outercryrad + plateDist, outercryheight + plateDist, 0, CLHEP::twopi);
    logicInnerWatertank = new G4LogicalVolume(solidInnerWatertank, H2O, "logicInnerWatertank");
    physInnerWatertank = new G4PVPlacement(0, G4ThreeVector(0.,0.,0.), logicInnerWatertank, "physInnerWatertank", logicPMMA, false, 0, true);
